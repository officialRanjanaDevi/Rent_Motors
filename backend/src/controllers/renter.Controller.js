...
const viewVehicleListing=asyncHandler(async(req,res)=>{
    ...
    // return res
     ...
     return res.status(200).json(new ApiResponse(200,vehicles,"vehicles are present"))

})


export {createVehicle,deleteVehicle,updateVehicle,updateImages, viewVehicleListing}